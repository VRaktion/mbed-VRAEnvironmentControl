...
VRAEnvironmentControl::VRAEnvironmentControl(
    UUID *p_uuid, EventQueue *p_eq, StateChain *p_stateChain, I2C *p_i2c) : BLEService("envCtrl", p_uuid, p_eq, p_stateChain),
                                                                            eq(p_eq),
                                                                            i2c(p_i2c)
{
...
float VRAEnvironmentControl::getTemperature(){
    return this->tempHumidSens->readTemperature();
}